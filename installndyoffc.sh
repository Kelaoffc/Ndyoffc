...
echo -e "  ___            __  __    __  __
 ...
 |___/ \_, /__/__/_/\_\_||_/_/\_\
       |__/  "
echo -e "\033[31m"
echo -e "\033[32mWHATSAPP : DyzzXnX\033[0m"
echo -e "\033[31mWEBSITE : https://t.me/DyzzXnX"
echo ""

animate_text "ANDA SUDAH TERVERIFIKASI, SILAHKAN MASUKAN LICENSE YANG DI BAGI DARI DyzzXnX"
animate_text "JIKA BELUM PUNYA LICENSE SILAHKAN BELI DI DyzzXnX, UNTUK HARGA 25K FREE UPDATE LICENSE"
animate_text " CONTACT DyzzXnX: "
echo -e "${RED}WHATSAPP: DyzzXnX${NC}"
echo -e "${RED}WEBSITE : https://t.me/DyzzXnX${NC}"
echo -e "${GREEN}"
...
# Menampilkan opsi tanpa animasi
  ...
  echo -e "${BLUE}[+]            ©COPYRIGHT BY https://t.me/DyzzXnX      [+]${NC}"
  echo -e "${BLUE}[+]                                                [+]${NC}"
  echo -e "${BLUE}[+] ============================================== [+]${NC}"
echo ""
 echo -e "${BLUE}[+] ============================================== [+]${NC}"
...
read -p "MASUKAN NOMOR WHATSAPP ANDA ( ISI MENGGUNAKAN AWALAN CODE NOMOR EXAMPLE : 6285696742591 ) : " nomor_baru
...
if [ -f "$file_path" ]; then
    ...
    while true; do
        read -p "APAKAH ANDA INGIN MENGUBAH LINK COPYRIGHT (MAKSUDNYA ADALAH: JIKA KAMU MENGKLIK $copyright_baru OTOMATIS AKAN KE LINK YANG ANDA MASUKIN DISINI CONTOHNYA KE WHASTAPP: https://wa.me/6285696742591 HARUS MEMAKAI https:// DI DEPANNYA YA) (y/n) : " ubah_link
        show_loading
        if [ "$ubah_link" = "y" ]; then
